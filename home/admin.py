...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['id', 'title', 'img', 'price', 'max_quantity', 'min_quantity', 'display', 'latest', 'trending', 'description', 'created', 'update']
...
admin.site.register(Product,ProductAdmin)   # regsiter in the admin
